...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $insertQuery = "INSERT INTO Leg_instance (Leg_instance_id, Date, Departure_time, Arrival_Airport, Arrival_time, Leg_number, Airplane_id, Number_of_available_seats) 
                        VALUES ('$Leg_instance_id', '$Date', '$Departure_time', '$Arrival_Airport', '$Arrival_time', '$Leg_number', '$Airplane_id', '$Number_of_available_seats')";
